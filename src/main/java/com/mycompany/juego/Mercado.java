...
public class Mercado {
    ...
    public void cargarJugadores(){
        ...
        */
        ...
        Jugador vanDijk = new Jugador("van Dijk",2800000,"/com/mycompany/juego/imagenes/vanDijk.jpg",90,"DEFENSA");this.JugadoresMercado.add(vanDijk);
        ...
        Jugador alexander = new Jugador("Alexander-Arnold",1400000,"/com/mycompany/juego/imagenes/Alexander.jpg",86,"DEFENSA");this.JugadoresMercado.add(alexander);
        ...
        Jugador nuno = new Jugador("Nuno Mendes",1400000,"/com/mycompany/juego/imagenes/Nuno.jpg",86,"DEFENSA");this.JugadoresMercado.add(nuno);
